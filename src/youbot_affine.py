...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        ...
        pose_holo = [pose.pose.position.x,pose.pose.position.y+0.2,pose.pose.position.z]
        ...
        for i in range(1000):
            ...
            if e <0.001:
                break
            ramda = e + 0.002
            theta_np = inversekinematics(L,pose_holo,p0,ramda)
        ...
        perform_trajectory(arm_joint_1,arm_joint_2+theta[0],arm_joint_3+theta[1],arm_joint_4+theta[2],arm_joint_5)
